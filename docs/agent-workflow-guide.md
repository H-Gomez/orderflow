...
2. **Plan review (your highest-leverage minutes):** edit the plan like a design review — cut steps, flag invariants it missed, correct wrong assumptions. A 2-minute plan correction prevents a 40-minute wrong implementation. If the plan is confused, the _spec_ was — fix the spec and restart.
